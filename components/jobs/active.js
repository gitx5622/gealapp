...
const ActiveJobs = () => {
    ...
    const { active_list, isLoading, errorMessage } = userSelector;
    ...
    useEffect(() => {
        getActiveJobs(dispatch, activePage, per);
        ...
        <div>
            <Panel>
                <div style={{ display: "flex", justifyContent: "space-between", marginLeft: "10px", marginRight: "20px" }}>
                    <p style={{ fontSize: "24px", color: "#006D7E" }}>Active Jobs:</p>
                ...
                <table style={styles.table}>
                    ...
                    {active_list?.job_list?.jobs?.map((data, index) => (
                        <tr key={index}>
                ...
                {active_list?.job_list?.jobs && (
                    <Pagination size="md" total={active_list?.job_list?.pagination.count} limit={per} activePage={activePage} onChangePage={(page) => setActivePage(page)}/>
                )}
            </Panel>
            <Panel>
            <Divider />
