...
import {getRejectedJobs} from "../../state/actions/jobAction";
...
const RejectedJobs = () => {
    ...
    const { rejected_list, isLoading, errorMessage } = userSelector;
    ...
    useEffect(() => {
        getRejectedJobs(dispatch, activePage, per);
        ...
        <div>
            <Panel>
                <div style={{ display: "flex", justifyContent: "space-between", marginLeft: "10px", marginRight: "20px" }}>
                    <p style={{ fontSize: "24px", color: "#006D7E" }}>Rejected Jobs:</p>
                ...
                <table style={styles.table}>
                    ...
                    {rejected_list?.job_list?.jobs?.map((data, index) => (
                        <tr key={index}>
                ...
                {rejected_list?.job_list?.jobs && (
                    <Pagination size="md" total={rejected_list?.job_list?.pagination.count} limit={per} activePage={activePage} onChangePage={(page) => setActivePage(page)}/>
                )}
            </Panel>
            <Panel>
            <Divider />
            <p style={{ fontSize: "24px", color: "#006D7E" }}>Rejected Jobs Reports:</p>
            <Divider />
            <Grid fluid>
