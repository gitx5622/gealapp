...
import {getDeclinedJobs} from "../../state/actions/jobAction";
...
const DeclinedJobs = () => {
    ...
    const { declined_list, isLoading, errorMessage } = userSelector;
    ...
    useEffect(() => {
        getDeclinedJobs(dispatch, activePage, per);
        ...
        <div>
            <Panel>
                <div style={{ display: "flex", justifyContent: "space-between", marginLeft: "10px", marginRight: "20px" }}>
                    <p style={{ fontSize: "24px", color: "#006D7E" }}>Declined Jobs:</p>
                ...
                <table style={styles.table}>
                    ...
                    {declined_list?.job_list?.jobs?.map((data, index) => (
                        <tr key={index}>
                ...
                {declined_list?.job_list?.jobs && (
                    <Pagination size="md" total={declined_list?.job_list?.pagination.count} limit={per} activePage={activePage} onChangePage={(page) => setActivePage(page)}/>
                )}
            </Panel>
            <Panel>
            <Divider />
            <p style={{ fontSize: "24px", color: "#006D7E" }}>Declined Jobs Reports:</p>
            <Divider />
            <Grid fluid>
